...
public:
	...
	virtual void SetPrimarySeat(AActor* InActor) override;
	virtual void SetSecondarySeat(AActor* InActor) override;
	virtual FVector VehicleSecondarySeatGetOffLocation() override;
